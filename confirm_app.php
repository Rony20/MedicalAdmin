...
<meta charset="utf-8">
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
        ...
        <div class="card card-container">
            ...
            <form class="form-signin" method="POST" action="mail.php">
            	<center> <b><font color="green">Confirm Appointment</font></b> </center>
                <span id="reauth-email" class="reauth-email"></span>
                <input type="email" id="inputEmail" class="form-control" name="email" placeholder="Email address" value="<?php echo $a;  ?>" required autofocus>
                <br>
                <input type="time"  class="form-control" name="time" placeholder="time slot" required>
                <br>
                <textarea name="tt" placeholder="message.." class="form-control"></textarea>

                <div id="remember" class="checkbox">
                                    </div>
                <input type="submit" class="btn btn-lg btn-primary btn-block btn-signin" value="Get Updates To User">
            </form><!-- /form -->
